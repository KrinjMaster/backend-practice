    ...
    return (<>
        <div className="w-screen h-20 md:hidden fixed bottom-0">
            <div className='grid grid-cols-3 h-full bg-[#202020]'>
                <Link href={url?.url === undefined ? '/users/user' : url?.url} className={`${pathname === url?.url ? ' bg-indigo-600' : 'text-gray-500'} flex flex-col text-xl font-bold px-3 text-white items-center transition-all duration-150 ease-in-out`}>
                ...
                <Link href={'/users'} className={`${pathname === '/users' ? ' bg-indigo-600' : 'text-gray-500'} flex flex-col text-xl font-bold px-3 text-white items-center transition-all duration-150 ease-in-out`}>
                    <svg className="fill-current p-1 h-12 w-12" viewBox="0 0 18 18">
                ...
                <Link href={'/users/settings'} className={`${pathname === '/users/settings' ? ' bg-indigo-600' : 'text-gray-500'} flex flex-col text-xl font-bold px-3 text-white items-center transition-all duration-150 ease-in-out`}>
                    <svg className="fill-current p-1 h-12 w-12" viewBox="0 0 18 18">
