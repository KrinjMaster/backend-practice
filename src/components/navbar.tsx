    ...
    return (
        <div className="w-[25%] h-screen">
            <div className='flex flex-col items-center gap-0.5'>
                    ...
                    <Link href={'/users'} className={`${pathname === '/users' ? 'text-white bg-indigo-600' : 'text-gray-500 hover:bg-zinc-400 hover:bg-opacity-10'} flex text-2xl font-bold hover:text-white px-3 rounded-lg w-full items-center gap-3 transition-all duration-150 ease-in-out`}>
                        <svg className="fill-current p-1 h-10 w-10" viewBox="0 0 18 18">
                    ...
                    <Link href={url?.url === undefined ? '/users/user/settings' : url?.url+'/settings'} className={`${pathname === url?.url+'/settings' ? 'text-white bg-indigo-600' : 'text-gray-500 hover:bg-zinc-400 hover:bg-opacity-10'} flex text-2xl font-bold hover:text-white px-3 rounded-lg w-full items-center gap-3 transition-all duration-150 ease-in-out`}>
                        <svg className="fill-current p-1 h-10 w-10" viewBox="0 0 18 18">
