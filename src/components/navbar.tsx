    ...
    return (<>
        <div className="w-[25%] h-screen md:block hidden">
            <div className='flex flex-col items-center gap-0.5'>
                    <Link href={url?.url === undefined ? '/users/user' : url?.url} className={`${pathname.includes('/users/') ? pathname === url?.url ? 'text-white bg-violet-500' : 'text-gray-500 hover:bg-zinc-400 hover:bg-opacity-10' : 'text-gray-500 hover:bg-zinc-400 hover:bg-opacity-10'} flex text-2xl font-bold hover:text-white px-3 rounded-lg w-full items-center gap-3 transition-all duration-150 ease-in-out`}>
                    ...
                    <Link href={'/users'} className={`${pathname.includes('/users') ? pathname === url?.url ? 'text-gray-500 hover:bg-zinc-400 hover:bg-opacity-10' : pathname.includes('messages') || pathname.includes('settings') ? 'text-gray-500 hover:bg-zinc-400 hover:bg-opacity-10' : 'text-white bg-violet-500' : 'text-gray-500 hover:bg-zinc-400 hover:bg-opacity-10'} flex text-2xl font-bold hover:text-white px-3 rounded-lg w-full items-center gap-3 transition-all duration-150 ease-in-out`}>
                        <svg className="fill-current p-1 h-10 w-10" viewBox="0 0 18 18">
                    ...
                    <Link href={'/users/messages'} className={`${pathname.includes('/users/messages') ? 'text-white bg-violet-500' : 'text-gray-500 hover:bg-zinc-400 hover:bg-opacity-10'} flex text-2xl font-bold hover:text-white px-3 rounded-lg w-full items-center gap-3 transition-all duration-150 ease-in-out`}>
                        <svg viewBox="0 0 24 24" stroke="currentColor" strokeLinecap="round" fillOpacity={0} strokeLinejoin="round" className='h-10 w-10 p-1 stroke-2'>
                            <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path>
                        </svg> 
                        Messages
                    </Link>
                    <Link href={'/users/settings'} className={`${pathname === '/users/settings' ? 'text-white bg-violet-500' : 'text-gray-500 hover:bg-zinc-400 hover:bg-opacity-10'} flex text-2xl font-bold hover:text-white px-3 rounded-lg w-full items-center gap-3 transition-all duration-150 ease-in-out`}>
                        <svg className="fill-current p-1 h-10 w-10" viewBox="0 0 18 18">
